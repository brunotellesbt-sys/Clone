export const trainerSpriteData: { [generation: number]: { [gender: string]: string } } = {
        ...
        9: {
            male: 'https://archives.bulbagarden.net/media/upload/6/62/Spr_Masters_Florian_2.png',
            female: 'https://archives.bulbagarden.net/media/upload/4/4a/Spr_Masters_Juliana.png'
        }
}
