...
export const gymLeadersByGeneration: Record<number, GymLeader[]> = {
  ...
  9: [
    ...
    },
    {
      ...
      quotes: [
        'A storm of artistic talent—let it bloom!'
      ]
    },
    {
      name: 'Iono',
      ...
      quotes: [
        "You're gonna be my next viral hit!"
      ]
    },
    {
      name: 'Kofu',
      ...
      quotes: [
        "Time to show you what my cooking's made of!"
      ]
    },
    {
      name: 'Larry',
    ...
    },
    {
      ...
      quotes: [
        'Get ready for a jam session of a battle!'
      ]
    },
    {
      name: 'Tulip',
    ...
    },
    {
      ...
      quotes: [
        "I'll chill you right to the bone."
      ]
    }
  ]
}
